...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChemadvisorChemApi.Identifier = factory(root.ChemadvisorChemApi.ApiClient, root.ChemadvisorChemApi.BaseDataType);
  }
   ...
   * @module chemadvisor.chemApi.model/Identifier
   * @version 0.9.6 beta
   */

  /**
   * Constructs a new <code>Identifier</code>.
   * @alias module:chemadvisor.chemApi.model/Identifier
   * @class
   ...
   * @param {module:chemadvisor.chemApi.model/Identifier} obj Optional instance to populate.
   * @return {module:chemadvisor.chemApi.model/Identifier} The populated <code>Identifier</code> instance.
   */
