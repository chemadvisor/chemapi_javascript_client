...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChemadvisorChemApi.Code = factory(root.ChemadvisorChemApi.ApiClient, root.ChemadvisorChemApi.BaseDataType);
  }
   ...
   * @module chemadvisor.chemApi.model/Code
   * @version 0.9.6 beta
   */

  /**
   * Constructs a new <code>Code</code>.
   * @alias module:chemadvisor.chemApi.model/Code
   * @class
   ...
   * @param code {String} 
   */
  var exports = function(dataType, name, prompt, value, code) {
    var _this = this;
   ...
   * @param {module:chemadvisor.chemApi.model/Code} obj Optional instance to populate.
   * @return {module:chemadvisor.chemApi.model/Code} The populated <code>Code</code> instance.
   */
