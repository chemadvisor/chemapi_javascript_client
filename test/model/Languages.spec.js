...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChemadvisorChemApi.Languages();
  });
  ...
  describe('Languages', function() {
    it('should create an instance of Languages', function() {
      // uncomment below and update the code to test Languages
      //var instane = new ChemadvisorChemApi.Languages();
      //expect(instance).to.be.a(ChemadvisorChemApi.Languages);
    });
