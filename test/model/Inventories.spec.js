...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChemadvisorChemApi.Inventories();
  });
  ...
  describe('Inventories', function() {
    it('should create an instance of Inventories', function() {
      // uncomment below and update the code to test Inventories
      //var instane = new ChemadvisorChemApi.Inventories();
      //expect(instance).to.be.a(ChemadvisorChemApi.Inventories);
    });
