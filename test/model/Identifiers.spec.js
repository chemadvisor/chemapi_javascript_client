...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChemadvisorChemApi.Identifiers();
  });
  ...
  describe('Identifiers', function() {
    it('should create an instance of Identifiers', function() {
      // uncomment below and update the code to test Identifiers
      //var instane = new ChemadvisorChemApi.Identifiers();
      //expect(instance).to.be.a(ChemadvisorChemApi.Identifiers);
    });
