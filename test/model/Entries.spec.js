...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChemadvisorChemApi.Entries();
  });
  ...
  describe('Entries', function() {
    it('should create an instance of Entries', function() {
      // uncomment below and update the code to test Entries
      //var instane = new ChemadvisorChemApi.Entries();
      //expect(instance).to.be.a(ChemadvisorChemApi.Entries);
    });
