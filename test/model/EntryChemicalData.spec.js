...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChemadvisorChemApi.EntryChemicalData();
  });
  ...
  describe('EntryChemicalData', function() {
    it('should create an instance of EntryChemicalData', function() {
      // uncomment below and update the code to test EntryChemicalData
      //var instane = new ChemadvisorChemApi.EntryChemicalData();
      //expect(instance).to.be.a(ChemadvisorChemApi.EntryChemicalData);
    });
