...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChemadvisorChemApi.BaseDataType();
  });
  ...
  describe('BaseDataType', function() {
    it('should create an instance of BaseDataType', function() {
      // uncomment below and update the code to test BaseDataType
      //var instane = new ChemadvisorChemApi.BaseDataType();
      //expect(instance).to.be.a(ChemadvisorChemApi.BaseDataType);
    });
