...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChemadvisorChemApi.Releases();
  });
  ...
  describe('Releases', function() {
    it('should create an instance of Releases', function() {
      // uncomment below and update the code to test Releases
      //var instane = new ChemadvisorChemApi.Releases();
      //expect(instance).to.be.a(ChemadvisorChemApi.Releases);
    });
